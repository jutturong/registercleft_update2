...
--
-- Host: localhost
-- Generation Time: Sep 28, 2016 at 04:01 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf32 COLLATE=utf32_bin AUTO_INCREMENT=38 ;
...
(32, 36, 'อ.สัญญา,อ.สุภาพร', '2013-03-12', '', '', '', '', 1),
(33, 37, 'อ.สุปรียา,อ.ภัทรมน', '2015-03-03', 'ABG with ICBG', '', '', '', 1),
(34, 38, 'อ.สุภาพร,อ.เสาวลักษณ์', '2010-11-30', 'ABG with ICBG', '', '', '', 1),
(35, 39, 'อ.สุภาพร,อ.สุทิน', '2013-06-25', 'ABG with ICBG', '', '', '', 1),
(37, 40, 'อ.ศิริพงศ์', '2011-10-11', 'ABG with ICBG', '', '', '', 1);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin AUTO_INCREMENT=28 ;
...
(11, 23, 'Complete left unilateral cleft lip with alveolus complete hard palate cleft', 1, ''),
(12, 24, 'Complete left unilateral cleft lip with alveolus complete hard palate cleft', 1, ''),
...
(23, 36, 'Complete Bilateral cleft lip with alveolau complete hard palate cleft', 1, ''),
(24, 37, 'Complete Bilateral cleft lip with alveolau complete hard palate cleft', 1, ''),
(25, 38, 'Complete Bilateral cleft lip with alveolau complete hard palate cleft', 1, ''),
(26, 39, 'Complete Bilateral cleft lip with alveolau complete hard palate cleft', 1, ''),
(27, 40, 'Complete right unilateral cleft lip with alveolus complete hard palate cleft', 1, '');
...
CREATE TABLE IF NOT EXISTS `tb_psot` (
  ...
  `cast` int(5) NOT NULL,
  PRIMARY KEY (`id_psot`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf16 COLLATE=utf16_bin AUTO_INCREMENT=24 ;
